    ...
    <div className="relative">
      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-20">
        <div className="text-center text-5xl">
          <h2>Dostojanstveno, <span className={`bg-gray-200 px-2 ${libre.className}`}>bez suvišnog.</span><br />Mir u trenucima oproštaja.</h2>
        </div>

        <div className="mt-8 flex items-center">
          <button className="bg-black text-white text-xs px-10 py-3 rounded-full">
            POZOVITE NAS
          </button>
      ...
      <section className="hidden mt-20 lg:flex items-start justify-center gap-4 px-4 max-w-5xl mx-auto">
        ...
        <div className="w-32 md:w-40 mt-8">
          <div className="relative h-44 md:h-52 rounded-2xl overflow-hidden">
    ...
    <section className="py-16 px-6 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          ...
          <div className="relative h-125 w-full md:w-[90%] overflow-hidden rounded-[40px] shadow-sm">
            <Image src="/cvece.svg"  alt="" fill className="object-cover" />
          </div>

          <div className="absolute -bottom-10 right-0 md:right-4 w-64 h-64 border-12 border-white rounded-[30px] overflow-hidden shadow-xl">
        ...
        <div className="space-y-6 lg:pl-12">
          ...
          <div className="pt-6 border-t border-gray-100 italic text-xl md:text-2xl font-serif text-slate-800 leading-snug">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-20">
              ...
              <p className="max-w-xl mx-auto text-gray-500 text-sm leading-relaxed font-light">
                Prilagođena podrška koja vam pomaže da odate počast voljenima na način koji najvernije odražava njihov duh.</p>
            </div>
      ...
      <section className="bg-[#E5E2DA] rounded-lg p-12 mb-10 text-center w-100 md:w-200">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="max-w-xl text-gray-600 leading-relaxed">
            ...
            naš saosećajni tim je uvek dostupan da vas sasluša i pruži podršku.</p>
        </div>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="flex items-center justify-center rounded-full px-8 py-3 bg-black text-white hover:bg-gray-800 transition-all w-full">
            <Phone className="mr-2 w-4 h-4" /> +381 63 377 658
          </button>
          
          <button className="border border-black rounded-full px-8 py-3 text-black text-xs hover:bg-black hover:text-white transition-all w-full">
            POŠALJI PORUKU
          </button>
        </div>
      </section>
