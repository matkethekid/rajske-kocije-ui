      ...
      <main className="w-full max-w-7xl mx-auto mt-10 flex flex-col gap-10 p-5 lg:p-0">
        <div className="flex flex-col lg:flex-row justify-between">
          <div className="flex flex-col gap-3">
            <h1 className={`text-[3.2rem] ${libre.className} max-w-xl`}>Administrativna pomoć nakon smrti u Beogradu</h1>
            <p className="max-w-xl">
              Pružamo stručnu administrativnu pomoć nakon smrti člana porodice. Pomažemo u pripremi dokumentacije, podnošenju zahteva i obavljanju svih 
              potrebnih procedura kako bismo olakšali organizaciju sahrane.
            </p>
