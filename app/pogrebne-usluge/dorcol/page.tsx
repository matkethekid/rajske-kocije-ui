        ...
        <div className="w-full min-h-screen bg-white relative flex flex-col">
            ...
            <main className="flex flex-col w-full lg:max-w-7xl mx-auto gap-3 p-5 lg:pr-10">
                <div className="flex flex-row items-center w-full justify-start">
                    ...
                    <p className="tracking-widest text-[0.750rem] uppercase">PREVOZ POKOJNIKA Dorćol</p>
                </div>
                <div className="flex flex-col lg:flex-row gap-5 justify-between">
                    <div className="flex flex-col gap-3">
                        ...
                        <p className="max-w-2xl text-[#5F5E58]">
                            ...
                            Prevoz pokojnika obavljamo specijalizovanim vozilima koja ispunjavaju sve zakonske i tehničke standarde. Svakom transportu pristupamo sa maksimalnim poštovanjem, diskrecijom i pažnjom, vodeći računa da celokupan proces bude organizovan dostojanstveno i bez dodatnog opterećenja za porodicu.
                        </p>
